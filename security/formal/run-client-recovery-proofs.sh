...
model=m15_client_recovery_boundary
expected=15
...
echo "m15_client_recovery_boundary: 15 verified"
echo "client recovery formal proof gate: 15 verified, 0 falsified, 0 warnings"
