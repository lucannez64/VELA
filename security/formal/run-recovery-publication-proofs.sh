...
model=m16_recovery_publication_consistency
expected=14
...
echo "m16_recovery_publication_consistency: 14 verified"
echo "recovery publication formal proof gate: 14 verified, 0 falsified, 0 warnings"
