...
fn main() {
    ...
    let result = tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            // destructive-action presence gates) can put a question to the
            // human through the same native-modal channel.
            state.register_host(host.clone());
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::passkey_provider::passkey_provider_register,
            commands::passkey_provider::passkey_provider_unregister,
            commands::passkey_provider::passkey_provider_status,
            commands::passkey_provider::passkey_provider_sync,
            ...
            commands::rekey::rotate_vault_keys,
            ...
            commands::vault::get_deleted_items,
            commands::vault::restore_item,
            commands::vault::purge_deleted_item,
            ...
            commands::vault::export_vault_encrypted_file,
            commands::vault::import_vela_archive,
            ...
            commands::recovery::seal_trusted_contact_share,
            ...
            commands::recovery::discard_recovery_setup,
            commands::recovery::fetch_cloud_recovery_shares,
            commands::recovery::complete_account_recovery,
            commands::recovery::complete_account_recovery_with_contact,
            commands::recovery::generate_recovery_request,
